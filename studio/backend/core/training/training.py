...
class TrainingBackend:
    ...
    def start_training(self, job_id: str, **kwargs) -> bool:
        ...
        config = {
            ...
            "is_prompt_baking": kwargs.get("is_prompt_baking", False),
            "baking_system_prompt": kwargs.get("baking_system_prompt", ""),
            "baking_num_trajectories": kwargs.get("baking_num_trajectories", 4),
            "baking_trajectory_length": kwargs.get("baking_trajectory_length", 128),
            "baking_temperature": kwargs.get("baking_temperature", 1.0),
            "baking_sampling_temperature": kwargs.get("baking_sampling_temperature", 0.8),
            "baking_use_prefill": kwargs.get("baking_use_prefill", False),
