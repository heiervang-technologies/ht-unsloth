...
async def start_training(
    ...
    try:
        ...
        training_kwargs = {
            ...
            "is_prompt_baking": request.is_prompt_baking,
            "baking_system_prompt": request.baking_system_prompt or "",
            "baking_num_trajectories": request.baking_num_trajectories,
            "baking_trajectory_length": request.baking_trajectory_length,
            "baking_temperature": request.baking_temperature,
            "baking_sampling_temperature": request.baking_sampling_temperature,
            "baking_use_prefill": request.baking_use_prefill,
